...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Normalisasi Matrik 3</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('analisis') }}">Analisis</a></li>
                        <li class="breadcrumb-item active">Normalisasi Matrik 3</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Tabel Normalisasi Matrik 3</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <th><input type="number" class="form-control" name="k29"
                                                    value="{{ $k29 }}" readonly></th>
                                        </tr>
                                    </tbody>
                                </table>
                                <div class="row">
